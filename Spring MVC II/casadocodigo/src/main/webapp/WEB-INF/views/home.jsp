...
<section id="index-section" class="container middle">
		...
		<c:forEach items="${produtos}" var="produto">
			<li>
				<a href="${s:mvcUrl('PC#detalhe').arg(0, produto.id).build()}" class="block clearfix">
					...
					<img width="143" height="202" src="${contextPath}${produto.sumarioPath}" alt="Java 8 Prático" title="Java 8 Prático" /> 
	...
	<ul id="cdc-diferenciais" class="clearfix">
		...
		<li class="col-right">
			...
			<p>
				<span class="sprite" id="sprite-renome"></span> Autores que participam ativamente na comunidade com Open Source, listas de discussão, grupos e mais.
			</p>
		</li>
		<li class="col-left">
