...
import br.com.casadocodigo.loja.conf.MyWebSecurityConfiguration;

@WebAppConfiguration
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes = { JPAConfiguration.class, AppWebConfiguration.class, 
		DataSourceConfigurationTest.class, MyWebSecurityConfiguration.class })
@ActiveProfiles("test")
	...
	public void somenteAdminDeveAcessarProdutosForm() throws Exception{
	    mockMvc.perform(MockMvcRequestBuilders.get("/produtos/form")
	            .with(SecurityMockMvcRequestPostProcessors
	                .user("antunes@willian.com.br").password("123456")
	                .roles("USUARIO")))
